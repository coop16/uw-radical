...
<!-- Added the custom knit so that saves file with the date at the end (so new file name each week) --> 
...
(_i.e. Due to transimssion issues or being serviced etc._)
...
#output code with code right after chunk
